...
<template>
  <div class="fz-three-columns-template flex flex-col h-full min-h-0 bg-core-white">
    <!-- Header bar. A plain container, NOT a <header> banner landmark: the app's
         ...
         the source's <FzDivider> (grey-200). -->
    <div
      class="fz-three-columns-template__header flex items-center justify-between gap-8 px-16 py-16 shrink-0 max-h-[64px] border-b-1 border-solid border-grey-200"
    >
      <div class="fz-three-columns-template__header-left flex items-center gap-8 min-w-0">
        <slot name="header-left" />
      </div>
      <div class="fz-three-columns-template__header-right flex items-center gap-8 shrink-0">
    ...
    <div
      class="fz-three-columns-template__body flex items-start flex-1 min-h-0 overflow-hidden"
    >
      <!-- Collapsible list/navigation sidebar (a complementary landmark). -->
      <FzLayoutAside
        class="fz-three-columns-template__sidebar flex flex-col h-full overflow-hidden transition-[width] duration-200 ease-in-out"
      ...
      >
        ...
        <div
          class="fz-three-columns-template__sidebar-header flex items-center gap-8 p-16 shrink-0"
        ...
        <div
          ...
          class="fz-three-columns-template__sidebar-filter px-16 pb-16 shrink-0"
        >
          <slot name="sidebar-filter" />
        </div>

        <div class="border-b-1 border-solid border-grey-200" />
        ...
        <!-- Scrollable sidebar body. v-show (NOT v-if): preserves DOM identity so
             ...
             this content stay valid across collapse/expand. -->
        <div
          v-show="!sidebarCollapsed"
          class="fz-three-columns-template__sidebar-content flex-1 min-h-0 w-full overflow-y-auto p-16"
        >
      ...
      <component
        :is="mainAs"
        class="fz-three-columns-template__columns flex flex-1 min-w-0 h-full overflow-hidden"
      >
        ...
        <div
          class="fz-three-columns-template__column-left flex flex-col flex-1 min-w-0 h-full overflow-hidden border-x-1 border-solid border-grey-200 pb-8"
        >
        ...
        <div
          class="fz-three-columns-template__column-right flex flex-col flex-1 min-w-0 h-full"
        >
          <div class="fz-three-columns-template__column-right-header p-16 shrink-0">
          ...
          <div
            class="fz-three-columns-template__column-right-content flex-1 min-h-0 overflow-y-auto px-16 pb-16"
          >
