/**
 * Type definitions for FzTypeahead internal components.
 *
...
/**
 * Props for FzTypeaheadLabel component
 *
 * Presentational component that renders the label with required indicator.
 */
export interface FzTypeaheadLabelProps {
  /**
...
export interface FzTypeaheadButtonProps {
   ...
   */
  selectedOption?: FzTypeaheadOptionProps;
  /**
...
/**
 * Props for FzTypeaheadHelpError component
 *
 * Presentational component that renders help text or error message.
 */
export interface FzTypeaheadHelpErrorProps {
  /**
   * Whether typeahead is in error state
   */
  error?: boolean;
...
/**
 * Props for FzTypeaheadOptionsList component
 *
 * Presentational component that renders the list of options with lazy loading support.
 */
export interface FzTypeaheadOptionsListProps {
  /**
   ...
   */
  visibleOptions: FzTypeaheadOptionsProps[] | undefined;
  /**
