...
describe.concurrent("FzContainer", () => {
  ...
  describe("AlignItems", () => {
    it("applies align-items-stretch by default for vertical", async ({
      expect,
    }) => {
      const wrapper = mount(FzContainer);
    ...
    it("applies align-items-center by default for horizontal", async ({
      expect,
    }) => {
      const wrapper = mount(FzContainer, {
    ...
    it("applies align-items-stretch when explicitly set", async ({
      expect,
    }) => {
      const wrapper = mount(FzContainer, {
    ...
    it("applies align-items-baseline when explicitly set", async ({
      expect,
    }) => {
      const wrapper = mount(FzContainer, {
    ...
    it("overrides default alignment for vertical container", async ({
      expect,
    }) => {
      const wrapper = mount(FzContainer, {
    ...
    it("overrides default alignment for horizontal container", async ({
      expect,
    }) => {
      const wrapper = mount(FzContainer, {
  ...
  describe("Orientation - Vertical (default)", () => {
    ...
    it("applies vertical class when horizontal is false", async ({
      expect,
    }) => {
      const wrapper = mount(FzContainer, {
  ...
  describe("Layout - Horizontal only", () => {
    it("applies layout-default class by default in horizontal", async ({
      expect,
    }) => {
      const wrapper = mount(FzContainer, {
        props: { horizontal: true },
    ...
    it("applies layout-default class when explicitly set", async ({
      expect,
    }) => {
      const wrapper = mount(FzContainer, {
    ...
    it("applies layout-expand-all class", async ({ expect }) => {
      ...
      expect(wrapper.classes()).not.toContain("layout-default");
      expect(wrapper.classes()).not.toContain("layout-expand-first");
      expect(wrapper.classes()).not.toContain("layout-expand-equal");
      expect(wrapper.classes()).not.toContain("layout-space-between");
    });

    it("applies layout-expand-equal class", async ({ expect }) => {
      const wrapper = mount(FzContainer, {
        props: { horizontal: true, layout: "expand-equal" },
      });

      expect(wrapper.classes()).toContain("layout-expand-equal");
      expect(wrapper.classes()).not.toContain("layout-default");
      expect(wrapper.classes()).not.toContain("layout-expand-first");
      expect(wrapper.classes()).not.toContain("layout-expand-all");
      expect(wrapper.classes()).not.toContain("layout-space-between");
    ...
    it("does not apply layout class for vertical orientation", async ({
      expect,
    }) => {
      const wrapper = mount(FzContainer);
    ...
    it("logs console.error when layout is used without horizontal", async ({
      expect,
    }) => {
    ...
    it("does not log console.error when layout is default without horizontal", async ({
      expect,
    }) => {
      const consoleErrorSpy = vi
        .spyOn(console, "error")
    ...
    it("does not log console.error when layout is used with horizontal", async ({
      expect,
    }) => {
      const consoleErrorSpy = vi
        .spyOn(console, "error")
  ...
  describe("Props combinations", () => {
    ...
    it("combines horizontal, gap, and layout expand-last correctly", async ({
      expect,
    }) => {
      const wrapper = mount(FzContainer, {
        props: {
  ...
  describe("Accessibility", () => {
    describe("Semantic HTML structure", () => {
      it("should render as div by default (no landmark role)", async ({
        expect,
      }) => {
        const wrapper = mount(FzContainer);
      ...
      it("should render as main element when tag is main", async ({
        expect,
      }) => {
        const wrapper = mount(FzContainer, {
          props: { tag: "main" },
      ...
      it("should render as section element when tag is section", async ({
        expect,
      }) => {
        const wrapper = mount(FzContainer, {
          props: { tag: "section" },
      ...
      it("should render as article element when tag is article", async ({
        expect,
      }) => {
        const wrapper = mount(FzContainer, {
          props: { tag: "article" },
      ...
      it("should render as aside element when tag is aside", async ({
        expect,
      }) => {
        const wrapper = mount(FzContainer, {
          props: { tag: "aside" },
      ...
      it("should render as form element when tag is form", async ({
        expect,
      }) => {
        const wrapper = mount(FzContainer, {
          props: { tag: "form" },
      ...
      it("should render as header element when tag is header", async ({
        expect,
      }) => {
        const wrapper = mount(FzContainer, {
          props: { tag: "header" },
      ...
      it("should render as footer element when tag is footer", async ({
        expect,
      }) => {
        const wrapper = mount(FzContainer, {
          props: { tag: "footer" },
    ...
    describe("ARIA attributes", () => {
      ...
      it("should support aria-describedby attribute", async ({ expect }) => {
        const wrapper = mount(FzContainer, {
          ...
          slots: {
            default:
              '<p id="section-description">Description</p><p>Content</p>',
          },
        });
      ...
      it("should support aria-label with semantic main tag", async ({
        expect,
      }) => {
        const wrapper = mount(FzContainer, {
          props: { tag: "main" },
      ...
      it("should support aria-labelledby with semantic section tag", async ({
        expect,
      }) => {
        const wrapper = mount(FzContainer, {
          props: { tag: "section" },
      ...
      it("should support aria-label with semantic nav tag", async ({
        expect,
      }) => {
        const wrapper = mount(FzContainer, {
          props: { tag: "nav" },
    ...
    describe("Semantic structure expectations", () => {
      it("should maintain semantic structure with all props", async ({
        expect,
      }) => {
        const wrapper = mount(FzContainer, {
          props: {
      ...
      it("should work with semantic tags in vertical orientation", async ({
        expect,
      }) => {
        const wrapper = mount(FzContainer, {
          props: {
      ...
      it("should work with semantic tags in horizontal orientation", async ({
        expect,
      }) => {
        const wrapper = mount(FzContainer, {
          props: {
    ...
    describe("Edge Cases", () => {
      it("should handle aria-label with empty string gracefully", async ({
        expect,
      }) => {
        const wrapper = mount(FzContainer, {
          attrs: { "aria-label": "" },
      ...
      it("should handle aria-labelledby pointing to non-existent element", async ({
        expect,
      }) => {
        const wrapper = mount(FzContainer, {
      ...
      it("should support multiple semantic containers with unique aria-labels", async ({
        expect,
      }) => {
      ...
      it("should preserve all accessibility attributes when combined with layout props", async ({
        expect,
      }) => {
        const wrapper = mount(FzContainer, {
          props: {
  ...
  describe("Snapshots", () => {
    ...
    it("matches snapshot - vertical with main and lg gap", async ({
      expect,
    }) => {
      const wrapper = mount(FzContainer, {
        props: { main: true, gap: "lg" },
    ...
    it("matches snapshot - horizontal with main and sm gap", async ({
      expect,
    }) => {
      const wrapper = mount(FzContainer, {
    ...
    it("matches snapshot - horizontal with layout expand-first", async ({
      expect,
    }) => {
      const wrapper = mount(FzContainer, {
        props: { horizontal: true, layout: "expand-first" },
    ...
    it("matches snapshot - horizontal with layout default", async ({
      expect,
    }) => {
      const wrapper = mount(FzContainer, {
        props: { horizontal: true, layout: "default" },
    ...
    it("matches snapshot - horizontal with layout expand-all", async ({
      expect,
    }) => {
      const wrapper = mount(FzContainer, {
        props: { horizontal: true, layout: "expand-all" },
    ...
    it("matches snapshot - horizontal with layout expand-equal", async ({
      expect,
    }) => {
      const wrapper = mount(FzContainer, {
        props: { horizontal: true, layout: "expand-equal" },
        slots: {
          default:
            "<button>OK</button><button>Salva e continua</button><button>Annulla</button>",
        },
      });
    ...
    it("matches snapshot - horizontal with layout space-between", async ({
      expect,
    }) => {
      const wrapper = mount(FzContainer, {
        props: { horizontal: true, layout: "space-between" },
    ...
    it("matches snapshot - horizontal with layout expand-last", async ({
      expect,
    }) => {
      const wrapper = mount(FzContainer, {
        props: { horizontal: true, layout: "expand-last" },
    ...
    it("matches snapshot - vertical with alignItems center", async ({
      expect,
    }) => {
      const wrapper = mount(FzContainer, {
        props: { alignItems: "center" },
    ...
    it("matches snapshot - vertical with alignItems end", async ({
      expect,
    }) => {
      const wrapper = mount(FzContainer, {
        props: { alignItems: "end" },
    ...
    it("matches snapshot - horizontal with alignItems start", async ({
      expect,
    }) => {
      const wrapper = mount(FzContainer, {
        props: { horizontal: true, alignItems: "start" },
    ...
    it("matches snapshot - horizontal with alignItems end", async ({
      expect,
    }) => {
      const wrapper = mount(FzContainer, {
    ...
    it("matches snapshot - horizontal with alignItems baseline", async ({
      expect,
    }) => {
      const wrapper = mount(FzContainer, {
