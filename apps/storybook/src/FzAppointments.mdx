...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Description text for the alert shown when the selected day has no slots. When no day at
        all carries slots, the day navigation is hidden and the default becomes{' '}
        <code>"Al momento non ci sono orari disponibili."</code>, since there is no other day to
        pick.
      </td>
    </tr>
  </tbody>
