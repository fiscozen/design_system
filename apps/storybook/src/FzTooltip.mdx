...
<Meta title="Documentation/Overlay/FzTooltip" />
...
<template>
  <div class="dashboard-actions">
    ...
    <FzTooltip 
      ...
      :interactive="false"
    >
      <FzButton disabled>Delete Item</FzButton>
    </FzTooltip>
...
To add support for new interactive components, follow these steps:
...
Example:
```typescript
// In packages/tooltip/src/FzTooltip.vue
import { FzButton } from '@fiscozen/button'
...
- **[Tooltip Stories](../?path=/docs/overlay-fztooltip--docs)** - Live examples and interactive demos
- **[Neutral Tooltip](../?path=/story/overlay-fztooltip--neutral-tooltip)** - Basic tooltip example
- **[With Interactive Elements](../?path=/story/overlay-fztooltip--with-interactive-elements)** - Auto-detection demo

### Related Components
- **[FzButton](../?path=/docs/button-fzbutton--docs)** - Button component (auto-detected)
- **[FzLink](../?path=/docs/navigation-fzlink--docs)** - Link component (auto-detected)
- **[FzFloating](../?path=/docs/composables-fzfloating--docs)** - Floating positioning system
