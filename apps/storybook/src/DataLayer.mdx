...
**Options:** `immediate` (default true), `refetch`, `initialData`, `deduplication`.
...
|--------|--------|-------------|
| `callListActionWithDefaults` | useList | defaultParams?, defaultOptions?, additionalParamsOrOptions?, additionalOptions? |
