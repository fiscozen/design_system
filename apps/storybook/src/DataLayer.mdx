...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>No</td>
      <td>-</td>
      <td>Normalize path trailing slash: <code>true</code> = always add, <code>false</code> = always remove, <code>null</code>/omit = don't change. Per-request: UseFzFetchOptions.trailingSlash overrides setup; <code>null</code> = no normalization for that request, omit = use setup.</td>
    </tr>
    <tr>
