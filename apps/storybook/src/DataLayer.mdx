...
| `sort` | `Array<Record<string, 'asc' \| 'desc'>> \| Ref \| ComputedRef` | ❌ No | Initial sort parameters as array (e.g., `[{ name: 'asc' }, { created_at: 'desc' }]`). After initialization, modify the returned `sort` reactive array directly. |
