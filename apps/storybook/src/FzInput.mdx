...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><code>string</code></td>
      <td>-</td>
      <td>Font Awesome icon name displayed as second icon on the right side of input. Order: valid > secondRightIcon > rightIcon (all can be present simultaneously)</td>
    </tr>
    <tr>
...
You can display a second icon on the right side. The display order is: `valid` checkmark > `secondRightIcon` > `rightIcon`. All three can be present simultaneously.
