    ...
    template: `
        <div class="bg-gray-100 p-8">
          <form class="fz-container-stack-v fz-container-gap-md fz-container-padding-lg bg-white rounded shadow mx-auto">
            ...
            <fieldset class="fz-container-grid-responsive-sm fz-container-gap-md border-2 hover:border-red-300 border-dashed">
            ...
            <fieldset class="fz-container-stack-v fz-container-gap-md border-2 hover:border-red-300 border-dashed">
              <FzInput label="Stack V" placeholder="Item F" />
              <FzInput label="Stack V" placeholder="Item G" />
            </fieldset>
            <fieldset class="fz-container-grid-responsive-1-2-3 fz-container-gap-md border-2 hover:border-red-300 border-dashed">
            ...
            <fieldset class="fz-container-stack-h fz-container-gap-md border-2 hover:border-red-300 border-dashed">
              <FzInput label="stack-h" placeholder="Item 6" />
              <FzInput label="stack-h" placeholder="Item 7" />
            </fieldset>
            <fieldset class="fz-container-stack-responsive-v-h fz-container-gap-md border-2 hover:border-red-300 border-dashed">
            ...
            <fieldset class="fz-container-stack-responsive-v-h-v fz-container-gap-md border-2 hover:border-red-300 border-dashed">
            ...
            <fieldset class="fz-container-stack-h fz-container-gap-md fz-container-stack-align-main-end border-2 hover:border-red-300 border-dashed">
